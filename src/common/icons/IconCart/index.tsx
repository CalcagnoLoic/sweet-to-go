    ...
    case "remove":
      return (
        <svg
          ...
          fill="none"
          viewBox="0 0 10 10"
          className="cursor-pointer self-center rounded-full border-[1px] border-clamShell fill-clamShell px-[3px] transition duration-150 ease-in-out hover:border-graphite hover:fill-graphite"
        >
